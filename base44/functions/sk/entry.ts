...
Deno.serve(async (req) => {
  ...
  try {
    ...
    console.log('[Skale] Payload recebido:', receivedAt, rawBody.substring(0, 500));
    ...
    return Response.json({ success: true, received: true, timestamp: receivedAt }, { headers: CORS_HEADERS });
